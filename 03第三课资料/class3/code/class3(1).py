...
df = pd.read_csv(
    # 该参数为数据在电脑中的路径，可以不填写
    filepath_or_buffer='D:/BaiduNetdiskDownload/Python股票量化投资课程（2017年）/03第三课资料/class3/data/sz000002.csv',
...
pd.set_option('max_colwidth', 19) # 设定每一列的最大宽度，恢复原设置的方法，pd.reset_option('max_colwidth')
